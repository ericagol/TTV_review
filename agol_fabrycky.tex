...
With the addition of multiple perturbing planets, if the mass-ratio of the planets to the star is
...
well.  The Kepler-19b planet showed sinusoidal TTVs that was used to identify a handful
of possible period and mass that might be responsible for the perturbations \citep{2011ApJ...743..200B}.
...
on a well-measured circular orbit may be used to measure the density of the star;
...
to the star.  Thus, two transiting planets yield an estimate of the density ratio of
...
to be constrained in this case as well \citep{1986ApJ...306L..37U}.
...
of planetary systems \citep{2015MNRAS.453.2644A}, but it may prove as fruitful
...
and radial-velocity of the binary give very precise constraints on the parameters
