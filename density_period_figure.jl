...
ax[:errorbar](period[irv],density[irv],sdensity[irv],c="r",alpha=0.25,fmt="o",label="RV")
#ax[:scatter](period[irv1],density[irv1],c="g",alpha=0.25,label = "RV single",s=mult[irv1]*50.)
ax[:errorbar](period[irv1],density[irv1],sdensity[irv1],c="g",alpha=0.25,label = "RV single",fmt="o")
ax[:set_xscale]("log")
ax[:set_yscale]("log")
...
ax[:errorbar](period[ittv],density[ittv],sdensity[ittv],c="b",alpha=0.25,label="TTV",fmt="o")
